...
'''
input=open('C:\Users\Mario\Dropbox\Computer science\Python\NLP\coursera_nlp1_hmm\gene.train.rare','r')
output=open('C:\Users\Mario\Dropbox\Computer science\Python\NLP\coursera_nlp1_hmm\gene.counts.rare','w')
# Initialize a trigram counter
counter = Hmm(3)
# Collect counts
counter.train(input)
